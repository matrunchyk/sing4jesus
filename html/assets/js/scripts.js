(function(){
	...
	// ****** GOOGLE MAP *******
	var map;
	var brooklyn = new google.maps.LatLng(49.4901493,24.1552046);
	...
	function initialize() {
		...
		var mapOptions = {
			...
			center: new google.maps.LatLng(49.4901493,24.1552046),
		...
		var myLatLng = new google.maps.LatLng(49.4901493,24.1552046);
