...
/*
*  acf_vue_container_plugin_update
*
...
class acf_vue_container_plugin_update
{
	var $settings;
	...
	*/
	...
	function __construct()
	{
		...
		$this->settings = array(
			'version'	=>	'',
			'remote'	=>	'https://download.digitalidea.studio/acf-vue-container/info',
...
if( is_admin() )
{
	new acf_vue_container_plugin_update();
}
